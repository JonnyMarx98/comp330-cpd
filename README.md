...
My plans for what I do after university are not certain at the moment, however I would like to be a programmer of some kind. Unlike previous years I am not completly sure I want to persue a games development career, I would like to experiment with other software development or website development after university. If I do decide to do games development, my goal would be to start out by making games independtly or in a small team, and then potentially move to a large game development company after that. The five key challenges I have identified this semester are not asking for help, specializing in a programming language, portfolio, self discipline, and breaking down tasks. To overcome not asking for help the only thing I can do is ask for help. I plan to specialize in C# by developing mobile games in my spare time in unity, I will then add these games to my portfolio to show that I have good C# skills. To improve self discpline I will work on the tasks I favour the least before doing any other work and reward myself for doing so. I will also break big dauting tasks down so that I am more likely to start and complete them. 
